...
void najtrudniejszy_przedmiot(student dane[100], int ile_rekordow)
{
    ...
    int przedmioty=znajdz_przedmiot(kod_przedmiotu,dane,ile_rekordow);
    char nazwa_przedmiotu[100][255];
    float suma_ocen[100];
    float srednia[100];
    float liczba_ocen[100];
    int i,j;
    int pozycja;
    int naj_pozycja;
    ...
    printf("Najtrudniejszy przedmiot: %s - %s:%f\n",kod_przedmiotu[naj_pozycja],
    nazwa_przedmiotu[naj_pozycja],srednia[naj_pozycja]);
